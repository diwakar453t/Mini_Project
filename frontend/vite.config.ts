...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'ChargeMitra - EV Charger Sharing',
        short_name: 'ChargeMitra',
        description: 'Find and share EV chargers across India',
        theme_color: '#FF9933',
        ...
        shortcuts: [
          {
            name: 'Find Chargers',
            short_name: 'Find',
            description: 'Search for nearby EV chargers',
            url: '/search',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: /^https:\/\/api\.chargemitra\.com\/.*/i,
